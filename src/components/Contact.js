    ...
    return (
        <div id="contact" className="w-[100vw] bg-[#f7ce5b]">
            ...
            <div className='bg-[#e9f1f7]' >
                <div>
                    <ParallaxBanner style={{ aspectRatio: '1 / 1' }} className="h-[30vh] sm:h-[30vh] sm:min-h-[250px] block ml-auto mr-auto">
                        <ParallaxBannerLayer image="media/bedroom2.jpg" speed={10} />
                        <ParallaxBannerLayer className='bg-[#21212138]' speed={0}>

                            <h2 className='font-["Yatra_One"] uppercase text-white pt-[5vh] lg:pt-[8vh] mr-[5vw] text-[60px] sm:text-[100px] md:text-[150px] lg:text-[160px] text-right'>
                                Contact
                            </h2>
                ...
                <p className='font-["Patrick_Hand"] ml-[15vw] pt-[5vh] pb-[3vh] text-[30px]'>For any inquiries, please reach me at:</p>
                ...
                <div className="borderwrapper p-[10px] pt-[30px] pb-[30px] w-fit block ml-auto mr-auto">
                    <div className='offsetBorder !border-black rounded-[5px] block ml-auto mr-auto'>
                        <h2 className='font-["Patrick_Hand"] text-[20px] md:text-[40px] lg:text-[60px] text-center ease-in duration-200'>
