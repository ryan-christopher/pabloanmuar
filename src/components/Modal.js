  ...
  return (
    <Backdrop className="fixed top-0 left-0 w-full h-full" onClick={handleClose}>
      <motion.div
        ...
        exit={'exit'}
      >
        <div className="bg-[#f7ce5b] backdrop-blur-sm border-[8px] rounded-lg border-[#f7ce5b] z-50 w-[95%] md:w-[75%] xl:w-[35vw] max-w-[800px] group" onClick={(e) => e.stopPropagation()} >
          ...
          <div className="bg-[#222725] w-full">
            ...
            <div className='inline-block origin-center ml-[-150px] group-hover:ml-[-120px] transition-[margin] duration-300'>
              <img className={`h-[200px] object-cover relative overflow-visible lg:h-[75%] z-[0] inline-block animate-[spin_4s_linear_infinite] [animation-play-state:running] origin-center`} src="media/vinyl.png" alt="" />
            </div>
          </div>
