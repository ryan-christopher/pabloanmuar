...
function home() {
    return (
        <div>
            {/* Site colors
                "Eerie Black" - #222725   "Alice Blue" - #e9f1f7  "Mustard" - #f7ce5b   
                "Gray" - #7c7c7c          "Cinnabar" - #d1603d     
            */}
            ...
            <div id="portfolio" className="min-h-[50vh] w-[100vw] bg-[#222725] text-white pb-[100px]">
