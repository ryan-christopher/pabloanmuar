        ...
        <div>
            ...
            */}
                    ...
                    <ParallaxBannerLayer className='bg-[#08080861] ease-in duration-200' speed={0}>
                        ...
                        <div className="text-white font-['Mynerve'] absolute bottom-[330px] right-[20px] font-bold pb-[72px] text-[40px] md:text-[70px] z-10">
                            <a href="#/" rel="noreferrer" target="_blank"><FaSpotify
                                className="social-link ml-[10px] mr-[10px] text-white ease-in duration-200" id="spotify" />
                            </a>
                        ...
                        <div className="text-white font-['Mynerve'] absolute bottom-[1vh] right-[50px] font-bold pb-[72px] text-[40px] md:text-[70px]">
            ...
            <div id="portfolio" className="min-h-[100vh] w-[100vw] bg-[#d1603d] text-white pb-[100px]">
                ...
                <h2 className='pt-[50px] font-["Bungee_Shade"] text-[50px] md:text-[75px] lg:text-[90px] text-center ease-in duration-200'>
                    Portfolio
                </h2>
                ...
                <span className='block ml-auto mr-auto w-[100vw] align-center text-right'>
                    <Parallax rotate={[-30, 30]} className="w-[10vw] min-w-[120px] inline-block max-w-[200px] 
                        ...
                        <img src="pabloDoodle.png" alt="" className="p-[0px] opacity-100 hover:scale-125 ease-in duration-200" aria-hidden="true" />
                    </Parallax>
                </span>
        ...
        */}
            ...
            <div className="w-[100vw] bg-[#f7ce5b] pb-[150px]">
                <div className="flex flex-col xl:flex-row justify-between w-[90vw] ml-[5vw] pt-[75px]">
                    <div className='flex-1 font-["Fredoka"] text-black text-[25px] lg:text-[30px] pt-[50px]'>
                    ...
                    <div className='flex-1 font-["Fredoka"] text-black text-[25px] lg:text-[30px] pt-[20px] xl:pt-[500px]'>
            ...
            <div id="contact" className="min-h-[100vh] w-[100vw] bg-[#e9f1f7]">
                <h2 className='font-["Mynerve"] text-[40px] md:text-[70px] pt-[72px] uppercase font-bold text-center w-[100%] block ml-auto mr-auto'>Pablo.Anmuar</h2>
